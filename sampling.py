...
def cifar_noniid(dataset, num_users):
    ...
    for i in range(num_users):
        if i<10:
            rand_set = [i,i+20]   #0-10,20-30
        elif i>=10 and i <20:
            rand_set = [i+20,i+30] ##30-40,40-50
        elif i>=20 and i<30:
            rand_set = [i+30,i+40] ##50-60,60-70
        elif i >=30 and i <40:
            rand_set = [i+40,i+50]
        elif i>=40 and i <50:
            rand_set = [i+50,i+60]
...
# def cifar_noniid(y_train, num_classes, p, num_users, seed, alpha_dirichlet=100):
#     np.random.seed(seed)
